...
# Data collection: list_of_Product ['CCost', 'Id', 'Profit', 'Promotion']

# Create a pandas Dataframe for each data table
list_of_Product = inputs[u'Product']
list_of_Product = list_of_Product[[u'CCost', u'Id', u'Profit', u'Promotion']].copy()
list_of_Product.rename(columns={u'CCost': 'CCost', u'Id': 'Id', u'Profit': 'Profit', u'Promotion': 'Promotion'}, inplace=True)
