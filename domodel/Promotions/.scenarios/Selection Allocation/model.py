...
# Data collection: list_of_Product ['CCost', 'Id', 'NOUB', 'Profit', 'Promotion', 'addquantitycost']

# Create a pandas Dataframe for each data table
list_of_Product = inputs[u'Product']
list_of_Product = list_of_Product[[u'CCost', u'Id', u'NOUB', u'Profit', u'Promotion', u'addquantitycost']].copy()
list_of_Product.rename(columns={u'CCost': 'CCost', u'Id': 'Id', u'NOUB': 'NOUB', u'Profit': 'Profit', u'Promotion': 'Promotion', u'addquantitycost': 'addquantitycost'}, inplace=True)
...
def build_model():
    ...
    # 	cSingleCriterionGoal.numericExpr = decisionPath(cSelection[Product])} with weight 8.0
    ...
    kpis_expression_list = [
        (1, 128.0, agg_Product_selectionVar_SG1, 1, 0, u'the number of Product selections'),
    ...
    # [ST_2] Constraint : cBasicSelectionLimitMin_cGlobalRelationalConstraint
    # The number of Product selections  is greater than or equal to 1
    # Label: CT_2_The_number_of_Product_selections__is_greater_than_or_equal_to_1
    agg_Product_selectionVar_lhs = mdl.sum(list_of_Product.selectionVar)
    ...
    # Label: CT_3_total_CCost_of_Products_over_all_selections_is_less_than_10000
    ...
    # Label: CT_4_For_each_Product__allocation_is_less_than_or_equal_to_NOUB
    ...
    # Label: CT_5_total_addquantitycost_of_Products_over_all_allocations_is_less_than_or_equal_to_45000000
    ...
    # [ST_6] Constraint : cLinkSelectionToAllocationConstraint_cIterativeRelationalConstraint
    # Synchronize selection with Product allocations
    # Label: CT_6_Synchronize_selection_with_Product_allocations
    ...
    # [ST_7] Constraint : cLinkSelectionToAllocationConstraint_cIterativeRelationalConstraint
    # Synchronize selection with Product allocations
    # Label: CT_7_Synchronize_selection_with_Product_allocations
    join_Product = list_of_Product.reset_index().merge(list_of_Product.reset_index(), left_on=['id_of_Product'], right_on=['id_of_Product'], suffixes=('', '_right')).set_index(['id_of_Product'])
    groupbyLevels = ['id_of_Product']
    groupby_Product = join_Product.allocationVar.groupby(level=groupbyLevels[0]).sum().to_frame(name='allocationVar')
