...
# Data collection: list_of_Customer ['Offer_id', 'Revenue', 'line']

# Create a pandas Dataframe for each data table
list_of_Customer = inputs[u'Customer']
list_of_Customer = list_of_Customer[[u'Offer id', u'Revenue']].copy()
list_of_Customer.rename(columns={u'Offer id': 'Offer_id', u'Revenue': 'Revenue'}, inplace=True)
